      ...
      <div style={s.container}>
        ...
        <div className="card" style={s.section}>
          <div style={s.sectionHeader}>
            ...
            <button className="btn btn-sm" onClick={handleLogout} style={{ color: "#f87171" }}>
              Sign Out
            </button>
          </div>
        </div>
          ...
          <div style={s.fields}>
            <div style={s.field}>
              ...
              <div style={{ fontSize: 11, color: "#555", marginTop: 4 }}>
                Default: agent_4001kmrcsfkpfbdsgb049vbvw37f (Alakh AI - Voice)
              </div>
            </div>
            <div style={s.field}>
              ...
              />
              <div style={{ fontSize: 11, color: "#555", marginTop: 4 }}>
                Default: agent_5801kmspe84efe7te6t0821sktpv (Chat Tutor)
              </div>
            </div>
          </div>
        </div>
